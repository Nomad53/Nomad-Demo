...
export default function Dashboard() {
  ...
  /* =========================================================
     UPDATE ASSIGNMENT
     PRESERVED FROM EXISTING DASHBOARD
     ========================================================= */
    ...
    <style>{`
      * {
      ...
      .loadingOrbit {
        ...
        border:
          1px solid rgba(216,198,166,.15);

        animation:
          loadingOrbitRotate 2s linear infinite;
      }
